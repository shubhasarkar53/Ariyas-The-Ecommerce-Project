        ...
        <Fragment>
          <div className="wrapper_confirm">
            ...
            <p className="message">
              ...
              order ships. Your estimated delivery date is indicated below.
              <br />
              If you would like to view the status of your order or make any
              changes to it, please visit Your Orders on Ariyas.in.
            </p>
